...
const runnerConfig = {
  browser1: { id: racerNames[0], script: scripts[0], displayName: settings.name1 || settings.names?.[racerNames[0]] || '' },
  browser2: { id: racerNames[1], script: scripts[1], displayName: settings.name2 || settings.names?.[racerNames[1]] || '' },
  executionMode,
  throttle,
